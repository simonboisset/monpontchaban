...
export const theme = {
  ...
  typography: {
    ...
    h2: { size: 28, font: 'Noto Sans', style: 'normal', weight: 500 },
    h3: { size: 20, font: 'Noto Sans', style: 'normal', weight: 500 },
    h5: { size: 16, font: 'Noto Sans', style: 'normal', weight: 600 },
    status: { size: 80, font: 'Noto Sans', style: 'normal', weight: 500 },
  },
  radius: 16,
  space,
  shadow,
