...
export const meta: MetaFunction = () => {
  return {
    ...
    description: "Règles de confidentialité de l'application Mon Pont Chaban",
  };
};
export default function Privacy() {
  return (
    <div className='flex flex-col space-y-2 p-12 text-justify'>
      ...
      <h2 className='text-lg'>Règles de confidentialité de l'application Mon Pont Chaban</h2>
      <p>
        L’application mobile « Mon Pont Chaban » est développée pour les téléphones mobiles sous le système
      ...
      <p>
        L’application mobile « Mon Pont Chaban » collecte des donées pour les smartophones ayant activé les
